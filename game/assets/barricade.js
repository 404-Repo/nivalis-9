// NIVALIS 9 code asset | barricade | construction 2
...
export default function generate(THREE) {
  ...
  for(const x of [-1.38,1.38]) B(x,.1,0,.55,.2,1.35,dark);

  chamfer(3.6,.9,.46,pale,0,.72,0,.18);
  for(const x of [-1.64,1.64]) B(x,.72,0,.2,1.1,.62,steel);
  for(const z of [-.26,.26]) {B(0,.72,z,2.9,.43,.035,dark);for(let x=-1.2;x<1.35;x+=.45)B(x,.72,z*1.04,.22,.42,.025,orange,-.42);bolts(-1.35,1.04,z,7,.45);}
  B(0,1.23,0,3.3,.1,.55,snow);
